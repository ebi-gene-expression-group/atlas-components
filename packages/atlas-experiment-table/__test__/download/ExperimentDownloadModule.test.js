...
describe(`ExperimentDownloadModule`, () => {
  ...
  beforeAll(() => {
    ...
    openDownloadPopup = loadExperimentDownloadModule(host, downloadFileTypes, popupPlaceholderId, callbackMock)
  })
  ...
  test(`does nothing if no filetypes are selected`, async () => {
    openDownloadPopup = loadExperimentDownloadModule(host, [], popupPlaceholderId, callbackMock)
    const experimentAccession = generateRandomExperimentAccession()
