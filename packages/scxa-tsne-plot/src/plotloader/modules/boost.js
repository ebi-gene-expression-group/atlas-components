// This is just the Boost module with the block prefixed by EDITED BY PVERSCHA added, so that a point can take a
// specific colour instead of being coloured by its series. This is a documented and known shortcoming/feature in
// Boost: https://github.com/highcharts/highcharts/issues/5999

/**
 * @license Highcharts JS v6.2.0 (2019-06-10)
 * Boost module
 *
		...
		function GLRenderer(postRenderCallback) {
		    ...
		    function pushSeriesData(series, inst) {
		        ...
		        while (i < sdata.length - 1) {
		            ...
		            // EDITED BY PVERSCHA
		            if (rawData[i].color) {
		                pcolor = H.color(rawData[i].color).rgba;
		                pcolor[0] /= 255.0;
		                pcolor[1] /= 255.0;
		                pcolor[2] /= 255.0;
		            }
