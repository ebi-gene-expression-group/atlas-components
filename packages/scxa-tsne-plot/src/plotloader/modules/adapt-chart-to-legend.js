// Pulled from yet-unreleased version https://github.com/highcharts/adapt-chart-to-legend/blob/ee0c4782f02182bbd9d541e2f9bc3e8919300359/adapt-chart-to-legend.js
    ...
    H.wrap(H.Legend.prototype, 'render', function (proceed) {
      ...
      if (this.options.adjustChartSize) { // #7
        ...
        if (addedHeight) {
          ...
          var boxedElement = chart.renderer.box;
